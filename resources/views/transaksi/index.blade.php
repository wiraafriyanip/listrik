...
<div class="card-body">
<a href="{{ route('transaksi.create') }}" class="btn btn-md btn-success mb-3">TAMBAH BLOG</a>
...
<tr>
<td class="text-center">{{ $transaksi->nomor }}</td>
<td class="text-center">{{ $transaksi->tgl }}</td>
