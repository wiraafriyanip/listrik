...
<div class="card-body">
<a href="{{ route('pengunjung.create') }}" class="btn btn-md btn-success mb-3">TAMBAH BLOG</a>
...
<tr>
<td class="text-center">{{ $pengunjung->nama }}</td>
<td class="text-center">{{ $pengunjung->alamat }}</td>

<td class="text-center">{{ $pengunjung->nohp }}</td>
